...
export default class SceneLoading extends Phaser.Scene {
    ...
    loadFullAssets() {
        ...
        this.load.atlas('character_02_idle_right', 'assets/images/players/player_2/character_02_idle_right.png', 'assets/images/players/player_2/character_02_idle_right_atlas.json');
        this.load.atlas('character_02_run_front', 'assets/images/players/player_2/character_02_run_front.png', 'assets/images/players/player_2/character_02_run_front_atlas.json');
        this.load.atlas('character_02_run_back', 'assets/images/players/player_2/character_02_run_back.png', 'assets/images/players/player_2/character_02_run_back_atlas.json');
        ...
        this.load.atlas('forest_guardian', 'assets/images/monsters/forest_guardian/forest_guardian.png', 'assets/images/monsters/forest_guardian/forest_guardian_atlas.json');
        this.load.atlas('gnollbrute', 'assets/images/monsters/gnoll_brute/gnollbrute.png', 'assets/images/monsters/gnoll_brute/gnollbrute_atlas.json');
        this.load.atlas('gnollshaman', 'assets/images/monsters/gnoll_shaman/gnollshaman.png', 'assets/images/monsters/gnoll_shaman/gnollshaman_atlas.json');
        this.load.atlas('wolf', 'assets/images/monsters/wolf/wolf.png', 'assets/images/monsters/wolf/wolf_atlas.json');
        this.load.atlas('largemushroom', 'assets/images/monsters/large_mush_room/largemushroom.png', 'assets/images/monsters/large_mush_room/largemushroom_atlas.json');
        this.load.atlas('smallmushroom', 'assets/images/monsters/small_mush_room/smallmushroom.png', 'assets/images/monsters/small_mush_room/smallmushroom_atlas.json');
        this.load.atlas('golem', 'assets/images/monsters/golem/golem.png', 'assets/images/monsters/golem/golem_atlas.json');
        ...
        // Animation JSONs register global anims — skip if already loaded (scene restarts)
        if (!this.anims.exists('character_01_idle')) {
            ...
            this.load.animation('character_02_idle_back_anim', 'assets/images/players/player_2/character_02_idle_back_anim.json');
            this.load.animation('character_02_idle_right_anim', 'assets/images/players/player_2/character_02_idle_right_anim.json');
            this.load.animation('character_02_run_front_anim', 'assets/images/players/player_2/character_02_run_front_anim.json');
            ...
            this.load.animation('treeman_anim', 'assets/images/monsters/tree_man/tree_man_anim.json');
            this.load.animation('forestguardian_anim', 'assets/images/monsters/forest_guardian/forest_guardian_anim.json');
            this.load.animation('gnollbrute_anim', 'assets/images/monsters/gnoll_brute/gnollbrute_anim.json');
            this.load.animation('gnollshaman_anim', 'assets/images/monsters/gnoll_shaman/gnollshaman_anim.json');
            this.load.animation('wolf_anim', 'assets/images/monsters/wolf/wolf_anim.json');
            this.load.animation('largemushroom_anim', 'assets/images/monsters/large_mush_room/largemushroom_anim.json');
            this.load.animation('smallmushroom_anim', 'assets/images/monsters/small_mush_room/smallmushroom_anim.json');
            this.load.animation('golem_anim', 'assets/images/monsters/golem/golem_anim.json');
